...
data "aws_availability_zones" "azs" {
  ...
  exclude_names = ["us-west-2-lax-1a","us-west-2-lax-1b","us-west-2-wl1-sfo-wlz-1"]
}
...
resource "aws_security_group" "port_80" {
  name = "port_80_sg_for_task_3_arjun"
  ingress {
    from_port = 80
    protocol = "tcp"
    to_port = 80
...
module "asg" {
  ...
  # Auto scaling group
  asg_name                  = "web-service-asg-task-3"
